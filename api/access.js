...
export default function handler(req, res) {
    ...
    try {
        ...
        const ACCESS_DB = [
            { ids: ['g01'], names: ['papa', 'padre', 'eugenio', 'Eugenio'], pin: '0001' },
            { ids: ['g02'], names: ['diego', 'diego y familia', "hermano", 'Hermano', 'Diego y familia'], pin: '0002' },
            { ids: ['g03'], names: ['tia elsa', 'elsa', 'Elsa'], pin: '0003' },
            { ids: ['g04'], names: ['mariana', 'mariana y familia', 'Mariana', 'Mariana y familia'], pin: '1021' },
            ...
            { ids: ['g14'], names: ['armando', 'Armando'], pin: '1225' },
            { ids: ['g15'], names: ['tia sandra', 'sandra', 'sandy', 'Sandra', 'Sandy'], pin: '1501' }
        ];
